        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl font-mono opacity-80 leading-relaxed">
                With over two decades of courtroom experience, I've built my reputation on one simple principle: 
                <strong className="text-foreground"> relentless advocacy for my clients.</strong>
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto">
            {timeline.map((item, i) => (
              <div
                key={i}
                className="flex gap-8 items-start mb-8 last:mb-0"
              >
